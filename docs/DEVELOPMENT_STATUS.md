...
| Wallboard learning integration | The lower Scoreboard rectangle remains available alongside the fixed viewport-fitting scoreboard slots. It rotates provider-attributed Headlines, provider-backed Hot Hitters, verified Lore & Curios, and verified biographies; future game-specific MLB previews will take priority when their preview story is available. No synthetic commentary is shown. |
