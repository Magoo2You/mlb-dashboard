...
| Schedule date semantics | Before the first current-day game starts, the passive Scoreboard may retain eligible prior-day final/carryover games alongside today’s slate. Once a current-day game is live, prior-day finals and completed games are removed; only current-day active and scheduled/pre-game games remain. Overlapping game IDs are deduplicated in favor of the current-day object. |
...
| Game Feed overview scope | When current-day live games exist, the wallboard Game Feed overview includes those active games plus current-day completed games; prior-day carryover finals are excluded after live play begins. Before any current-day game is live, eligible displayed-slate completed games remain available. |
