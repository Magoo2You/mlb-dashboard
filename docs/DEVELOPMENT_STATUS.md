...
| Wallboard header geometry | At the 1920x1080 desktop baseline, the wallboard header reserves a separate upper band for the global Views navigation. Its slide selector, pause control, and clock no longer overlap the global navigation. Fresh Chrome capture against port 4326 verified the corrected geometry. |
